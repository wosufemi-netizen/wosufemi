/**
 * cocote Worker — Telegram bot → GitHub Actions repository_dispatch
        ...
        ctx.waitUntil(
          tgSend(
            ...
            [
              ...
              "",
              "Capture auto: workflow <code>cocote</code> (cron UTC 58 11-13).",
            ].join("\n")
          )
        );
        return new Response("OK");
        ...
        ctx.waitUntil(
          tgSend(
            ...
            [
              ...
              "Record: Actions workflow <code>orvella-vault</code>",
              "Capture: Actions workflow <code>cocote</code>",
