...
(function(ctx) {
  ...
  ctx.portal = {};
  ctx.portal.portalVersion     = '2.3.3';
  ...
  ctx.portal.versionShow1st = false;
  ...
  ctx.portalVersion = function() {
    if (ctx.portal.versionShow1st === false) {
      ctx.portal.versionShow1st = true;
  ...
  ctx.portalRun = function(player) {
    ...
    ctx.plog('portalconf', ctx.portalconf);
