...
Bukan bandingin URL: status dari wosufemi/capture_status.json (ditulis m3u8_capture.py).
"""
...
STATUS_PATH = Path("wosufemi/capture_status.json")
LIVE_URL_PATH = Path("wosufemi/live_url.txt")
